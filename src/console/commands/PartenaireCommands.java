...
public class PartenaireCommands {
    ...
    public void addPartenaire(Scanner scanner) {
        ...
        TypeTransport typeTransport = TypeTransport.valueOf(typeTransportString.toUpperCase());
        ...
        StatutPartenaire statutPartenaire = StatutPartenaire.valueOf(statutPartenaireString.toUpperCase());
    ...
    // Méthode pour mettre à jour un partenaire
